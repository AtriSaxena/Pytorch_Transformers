...
# Input Embeddings for converting input to Embeddings
...
class MultiHeadAttentionBlock(nn.Module):
    def __init__(self, d_model: int, h: int, dropout: float, *args, **kwargs):
...
class ResidualConnection(nn.Module):
    ...
    def __init__(self, features: int, dropout: float, *args, **kwargs):
        super().__init__(*args, **kwargs)  
        self.dropout = nn.Dropout(dropout)
...
class EncoderBlock(nn.Module):
    ...
    def __init__(self, features: int, self_attention_block: MultiHeadAttentionBlock, feed_forward_block: FeedForwardBlock, dropout: float, *args, **kwargs):
        super().__init__(*args, **kwargs)
        self.self_attention_block = self_attention_block
        self.feed_forward_block = feed_forward_block
        self.residual_connections = nn.ModuleList([ResidualConnection(features, dropout) for _ in range(0,2)])
